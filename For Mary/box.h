...
struct Box
{
    ...
    */
    virtual bool intersect(Box &other) 
    {
    ...
    */
    virtual float intersectDown(Box &other)
    {
        // printf("\nIntersect down:\nm_pos_x: %f\tm_pos_y: %f\tm_width: %f\n", m_pos_x, m_pos_y, m_width);
        // printf("other.m_pos_x: %f\tother.m_pos_y: %f\tother.m_width: %f\n-----\n", other.m_pos_x, other.m_pos_y, other.m_width);
    ...
    *   anymore with the target Box (other), or 0.0f if no collision is found.
    */
    virtual float intersectSideways(Box& other)
    {
